    ...
    <div className="Footer maxwidth">
      ...
      <div className="FooterParentDiv">
        <div className="link_div">
          <div>
            <p className="medium footerHeading">FOR BUYERS</p>
            <div className="links">
              <p className="small">Our Buyers</p>
              <p className="small">Browse</p>
              <p className="small">Post Your Requirement</p>
              <p className="small">Entertainment on EMI</p>
            </div>
            <p className="medium footerHeading">ABOUT US</p>
            <div className="links">
        ...
        <div className="adress_div">
          <div>
            <p className="medium footerHeading">
      ...
      <div className="paymentd">
        ...
        <p>
          © Copyright 2015-2023 |{" "}
          <span className="small">VINSM Globe Pvt. Ltd.</span> | All Rights
          Reserved.
        </p>
      </div>
    </div>

...
function UperFooter() {
  return (
    <div className="UperFooter">
      <div>
        <h1 className="large">6000+ Users trust StarClinch.</h1>
        <p className="smallline">Booking Terms & Conditions</p>
      </div>

      <div>
        <p className="large">BOOKING TERMS & CONDITIONS FOR CLIENT</p>
        <p className="medium">Advance Fee and Payment Terms</p>
      </div>
      <div className="maxWidthforpoiter">
        <p className="boldPointer">All acts are subject to availability</p>
        <p className="boldPointer">GST @18% will be applicable</p>
        <p className="boldPointer">
